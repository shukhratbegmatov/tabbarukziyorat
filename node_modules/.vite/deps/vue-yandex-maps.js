...
var O = { pluginOptions: {}, provide: function() {
  ...
  var e2, t2, n2 = this;
  if (this.myMap = {}, this.markers = [], window.ymaps && ymaps.GeoObjectCollection && (this.initWithoutMarkers || null !== (e2 = (t2 = this.$slots).default) && void 0 !== e2 && e2.call(t2) || this.placemarks.length) && document.getElementById(this.ymapId)) {
  ...
  var e2;
  null !== (e2 = this.myMap) && void 0 !== e2 && e2.geoObjects && this.myMap.geoObjects.removeAll();
} };
