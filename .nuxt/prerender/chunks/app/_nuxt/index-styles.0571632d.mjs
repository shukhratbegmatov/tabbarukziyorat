...
const index_vue_vue_type_style_index_0_scoped_6fa3a0ca_lang = ".faq-item__icon[data-v-6fa3a0ca]{box-shadow:0 4px 20px rgba(229,69,69,.48)}.faq-section[data-v-6fa3a0ca]{background:url(" + publicAssetsURL("pattern/help.png") + ") no-repeat 50%;background-size:cover}";

const indexStyles_0571632d = [index_vue_vue_type_style_index_0_scoped_6fa3a0ca_lang];

export { indexStyles_0571632d as default };
//# sourceMappingURL=index-styles.0571632d.mjs.map
